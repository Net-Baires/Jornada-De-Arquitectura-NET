...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      dist: {
        src: ["!less/**.less", "!less/lib/*.css", "less/*.css"],
      },
    },
    ...
    less: {
      ...
      production: {
        ...
        files: {
          ...
          "css/min/style-blue-color.min.css":
            "less/styles/style-blue-color.less",
          "css/min/style-pink-color.min.css":
            "less/styles/style-pink-color.less",
          "css/min/style-green-color.min.css":
            "less/styles/style-green-color.less",
          "css/min/style-berry-color.min.css":
            "less/styles/style-berry-color.less",
          "css/min/style-orange-color.min.css":
            "less/styles/style-orange-color.less",
        },
      },
    },
